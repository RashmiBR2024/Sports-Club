...
const Location = () => {
  return (
    <div className="relative grid grid-rows-8 md:grid-rows-1 md:grid-cols-8 h-[500px] sm:h-[500px] lg:h-[300px] tablet:h-[300px] md:h-[300px] bg-blue-600 shadow-md overflow-hidden">
      {/* Left Section: Location Details */}
      <div className="relative z-10 flex flex-col justify-center p-4 sm:p-6 lg:p-8 space-y-4 bg-white row-span-3 md:col-span-3">
        <Title
          level={4}
      ...
      {/* Map Section */}
      <div className="relative row-span-5 md:col-span-5">
        <iframe
