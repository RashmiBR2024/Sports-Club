...
export const GET = async (req) => {
    ...
    try {
        ...
        const tournament = await tournamentdataModel.find().skip(skip).limit(limit);

        // Get the total count of documents
        const totalTournament = await tournamentdataModel.countDocuments();

        // Calculate the total number of pages
        const totalPages = Math.ceil(totalTournament / limit);
