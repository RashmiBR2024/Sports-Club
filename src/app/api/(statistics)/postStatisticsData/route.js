...
export const POST = async (req, res) => {
    ...
    try {
        ...
        let newStatistics = new statisticsdataModel(dataReceived);
        newStatistics = await newStatistics.save();

        // Respond with the saved data
        return NextResponse.json({ success: true, data: newStatistics }, { status: 200 });
    } catch (error) {
